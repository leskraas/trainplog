...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create trainplog-de3a
  fly apps create trainplog-de3a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app trainplog-de3a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app trainplog-de3a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'trainplog-de3a-staging' does not match app name in config file 'trainplog-de3a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name trainplog-de3a-db
  fly postgres attach --postgres-app trainplog-de3a-db --app trainplog-de3a

  fly postgres create --name trainplog-de3a-staging-db
  fly postgres attach --postgres-app trainplog-de3a-staging-db --app trainplog-de3a-staging
  ```
